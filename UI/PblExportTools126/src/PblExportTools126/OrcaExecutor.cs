...
namespace PblExportTools126
{
    internal class OrcaExecutor : OrcaExecutorBase
    {
        ...
        [DllImport("PBORC126.DLL", EntryPoint = "PBORCA_ConfigureSession", CharSet = CharSet.Auto)]
        private static extern int PBORCA_ConfigureSession(
            int hORCASession,
            PBORCA_CONFIG_SESSION pSessionConfig);

        [DllImport("PBORC126.DLL", EntryPoint = "PBORCA_LibraryEntryExport", CharSet = CharSet.Auto)]
