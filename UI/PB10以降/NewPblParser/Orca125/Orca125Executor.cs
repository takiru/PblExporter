...
namespace NewPblParser.Orca125
{
    /// <summary>
    /// PB125のORCA呼び出しを提供します。
    /// </summary>
    class Orca125Executor : OrcaExecutorBase
    {
        ...
        [DllImport("PBORC125.DLL", EntryPoint = "PBORCA_ConfigureSession", CharSet = CharSet.Auto)]
        private static extern int PBORCA_ConfigureSession(
            int hORCASession,
            PBORCA_CONFIG_SESSION pSessionConfig);

        [DllImport("PBORC125.DLL", EntryPoint = "PBORCA_LibraryEntryExport", CharSet = CharSet.Auto)]
