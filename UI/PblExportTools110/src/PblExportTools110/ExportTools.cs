...
namespace PblExportTools110
{
    ...
    {
        public decimal Version => 11.0m;

        public string PbVersion => "PB11.0";

        /// <summary>
        /// PBLオブジェクト一覧を取得するための実行ファイル名。
        /// </summary>
        public string ObjectListExecuteFileName => "pbobjectgetter110.exe";

        /// <summary>
        /// PBLオブジェクトコードを取得するための実行ファイル名。
        /// </summary>
        public string ObjectCodeExecuteFileName => "pbobjectparser110.exe";
