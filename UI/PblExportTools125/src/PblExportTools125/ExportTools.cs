...
namespace PblExportTools125
{
    [Export(typeof(IPbSupporter))]
    public class ExportTools : IPbSupporter
    {
        public decimal Version => 12.5m;

        public string PbVersion => "PB12.5";

        /// <summary>
        /// PBLオブジェクト一覧を取得するための実行ファイル名。
        /// </summary>
        public string ObjectListExecuteFileName => "pbobjectgetter125.exe";

        /// <summary>
        /// PBLオブジェクトコードを取得するための実行ファイル名。
        /// </summary>
        public string ObjectCodeExecuteFileName => "pbobjectparser125.exe";
